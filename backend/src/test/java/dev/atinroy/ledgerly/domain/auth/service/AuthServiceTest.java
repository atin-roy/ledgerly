...
class AuthServiceTest {
    ...
    class TokenRefresh {
        ...
        @Test
        @DisplayName("should fail refresh with access token")
        void shouldFailRefreshWithAccessToken() {
            RefreshTokenRequest request = new RefreshTokenRequest("valid_access_token");

            when(jwtService.isTokenValid("valid_access_token")).thenReturn(true);
            when(jwtService.isRefreshToken("valid_access_token")).thenReturn(false);
        ...
        void shouldFailRefreshWhenUserNotFound() {
            ...
            when(jwtService.isRefreshToken("valid_but_user_deleted")).thenReturn(true);
