...
class TransactionServiceTest {
    ...
    void setUp() {
        ...
        // TransactionResponse(id, amount, date, categoryName, partyName)
    ...
    class CreateTransaction {
        ...
        void shouldCreateTransactionSuccessfully() {
            ...
            when(transactionValidator.validate(request))
                    .thenReturn(dev.atinroy.ledgerly.error.ValidationResult.success());
        ...
        void shouldFailWhenValidationFails() {
            ...
            var validationResult = dev.atinroy.ledgerly.error.ValidationResult.withErrors();
